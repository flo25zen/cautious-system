var zayu_list1 =["楽","地獄への道","明日は明日","天上天下","情け","親しき仲","笑う門","継続","初心","好奇心","遅れてもやらない","ゴハン","真面目でいる","能ある鷹","花","弘法","七色","星","レンジ","残念","最高","ギリギリ","うっかり","危険","伝説","最悪","無敵","ヘッポコ","少年","少女","よわむしのぼく","優しさ","時"]
var zayu_list2 =["に","は","の"," ","にも","よりは","には","も","で","な","けれども","、実は","こそが"]
var zayu_list3 =["生きる","善意で舗装されている","風が吹く","唯我独尊","人の為ならず","礼儀あり","福来る","力なり","忘れるべからず","猫をも殺す","マシ","食べてユメをみて","馬鹿でいる","爪隠す","団子","筆の誤り","虹","カービィ","1分","おっさん","クリエーター","魔王","アニキ","アネキ","キーボード","卵かけご飯","大志を抱け","こんどこそ たたかうばんだ","本当の強さだ","全てを癒す"]
var min,max
function setword(){
